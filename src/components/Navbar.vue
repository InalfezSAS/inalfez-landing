<template>
  <header id="head">
            <a href="#" class="izquierda">
                <div class="logo">
                    <img src="https://res.cloudinary.com/ddegh9xqy/image/upload/v1632377670/Logo_Mesa_de_trabajo_1_in9ycy.png" alt="Logo">
                </div>
            </a>


            <ul :class="menu">
                <div class="salir" v-on:click="toggleCollapsed">
